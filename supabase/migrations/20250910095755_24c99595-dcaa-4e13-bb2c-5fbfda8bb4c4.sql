-- Add database triggers for security and validation

-- 1. Trigger for contact_messages validation (before insert)
CREATE TRIGGER validate_contact_message_trigger
  BEFORE INSERT ON public.contact_messages
  FOR EACH ROW
  EXECUTE FUNCTION public.validate_contact_message();

-- 2. Triggers for photos validation and audit logging
